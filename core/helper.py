...
from utils.logwraper import Logwrap, AirtestLogger
...
def import_device_cls(platform):
    ...
    if platform in G.CUSTOM_DEVICES:
        ...
        from core.android.android import Android as cls
    elif platform == "windows":
        from core.win.win import Windows as cls
    elif platform == "ios":
        from core.ios.ios import IOS as cls
    elif platform == "linux":
        from core.linux.linux import Linux as cls
    else:
