...
from core.android.constant import STFLIB, ORI_METHOD
from utils.logger import get_logger
from utils.nbsp import NonBlockingStreamReader
from utils.safesocket import SafeSocket
from utils.snippet import reg_cleanup, on_method_ready, ready_method
...
class Minicap(object):
    ...
    def get_display_info(self, serialno):
        """
