...
from core.android.constant import (DEFAULT_ADB_PATH, IP_PATTERN,
                                           SDK_VERISON_NEW)
from core.error import (AdbError, AdbShellError, AirtestError,
                                DeviceConnectionError)
from utils.compat import decode_path
from utils.logger import get_logger
from utils.nbsp import NonBlockingStreamReader
from utils.retry import retries
from utils.snippet import get_std_encoding, reg_cleanup, split_cmd
...
def retry(func):
    def wrapper(self, *args, **kwargs):
        # if self.serialno not in self.deivces():
        #     self.disconnect()
        #     self.connect()
...
class ADB(object):
    ...
    def __init__(self, serialno=None, adb_path=None, server_addr=None):
        ...
        self.adb_path = "/opt/adb/platform-tools/adb"
