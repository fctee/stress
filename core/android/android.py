...
from core.android.ime import YosemiteIme
from core.android.constant import CAP_METHOD, TOUCH_METHOD, IME_METHOD, ORI_METHOD, SDK_VERISON_NEW
from core.android.adb import ADB
from core.android.minicap import Minicap
from core.android.minitouch import Minitouch
from core.android.javacap import Javacap
from core.android.rotation import RotationWatcher, XYTransformer
from core.android.recorder import Recorder
...
class Android(Device):
    ...
    def __init__(self, serialno=None, host=None,
        ...
        self.ime_method = IME_METHOD.ADBIME
    ...
    def get_display_info(self):
        ...
        if self.ori_method == ORI_METHOD.MINICAP:
            display_info = self.minicap.get_display_info(self.serialno)
        else:
